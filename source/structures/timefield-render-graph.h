...
public:
    ...
    void SubmitRollNoteRenderCommand(const Column InColumn, const Time InTimeBegin, const Time InTimeEnd, const int InBeatSnapBegin = -1, const int InBeatSnapEnd = -1, const sf::Int8 InAlpha = 255);
